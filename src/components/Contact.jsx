              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-blue-700 dark:text-blue-300 text-sm">
                    <strong>Quick Contact:</strong> This form will open your default email client with the message pre-filled. 
                    You can also email me directly at <strong>mrityunjayeng720@gmail.com</strong>
                  </p>
                </div>
              </div>
            </div>
            ...
            {submitStatus === 'error' && (
              ...
              >
                ...
                <span className="text-red-700 dark:text-red-300">
                  Could not open email client. Please copy the message and email me directly.
                </span>
              </motion.div>
            )}
